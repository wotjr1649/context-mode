...
**Total context: ~430B** instead of 270K tokens — in this idealized flow the snapshot never touches context. Whole-session savings are workload-dependent: BENCHMARK.md measures 13–99% per scenario.
