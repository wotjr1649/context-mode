...
function codexRedirectReason(command) {
  ...
  return "ctxscribe: command redirected. Use the ctxscribe MCP tools (ctx_execute / ctx_fetch_and_index / ctx_search) so raw output stays out of the conversation.";
}
